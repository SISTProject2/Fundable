			                  ...
			                  <table class="u-table-entity">
			                    ...
			                    <tbody class="u-table-body">
			                      <tr style="height: 25px;">
			                        <td class="u-table-cell u-table-cell-1" style="font-weight: 700; font-size: 23px; padding: 20px;">총 <span style="color: red">${count }</span>개의 프로젝트를 올렸습니다</td>
			                      </tr>
						                  ...
						                  <table class="u-table-entity">
						                    ...
						                    <tbody class="u-table-body">
						                      ...
						                      <tr style="height: 50px; border: 1px solid lightgray;">
						                        ...
						                        <td class="u-align-center u-table-cell u-table-cell-8" style="font-weight: 700; font-size: 14px;">가격</td>
							                      ...
							                      <c:forEach var="vo" items="${list }">
								                      <tr style="height: 32px; border: 1px solid lightgray;">
								                        ...
								                        <td class="u-table-cell u-table-valign-middle u-table-cell-13" style="text-align: center;">
								                          <fmt:formatNumber pattern="#,###" value="${vo.price }"/>원
								                        </td>                     
