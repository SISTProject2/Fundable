...
<!--           <div class="u-repeater u-repeater-1" style="margin-left: 250px; margin-right: 250px; margin-top: 0px;"> -->
            <div class="u-container-style u-list-item u-repeater-item" v-for="vo in funding_data" style="width: 350px; height: auto;">
              <div class="u-container-layout u-similar-container u-container-layout-1" style="width: 350px; height: auto;">
                ...
                <h3 class="u-custom-font u-font-open-sans u-text u-text-palette-2-base u-text-5" style="width: 100%; font-size: 1.0rem;">{{vo.bellcount}}​명 알림신청 중</h3>
                <c:if test="${sessionScope.id==null }"> 
                  <span v-on:click="bellOn2()" :data-no="vo.fg_no" class="u-border-1 u-btn u-button-style u-none u-text-black u-btn-2" style="width: 100%; padding: 4px; border: 1px solid #b9c1cc; font-weight: 500;" ><span class="u-file-icon u-icon u-text-black u-icon-1"><img src="../css/img/1827422.png" alt=""></span>&nbsp;알림신청
                  </span>
                </c:if>
                <c:if test="${sessionScope.id!=null }">
    ...
    <script>
	  new Vue({
		...
		methods:{
			send:function(){
				let _this=this;
				axios.get("http://43.200.58.204/funding/soon_list.do",{
					params:{
						page:_this.curpage,
						ord:_this.ord
					}
