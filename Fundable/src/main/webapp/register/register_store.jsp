                      ...
                      <div>
                        <form action="../register/storeReg.do" method="post" ><!-- hidden inputs for siteId and pageId -->
                          ...
                          <div class="u-form-group u-form-name">
                            ...
                            <input type="text" placeholder="제목 입력" id="name-cade" name="title" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white u-input-1" required="" value="${fundingInfo.title}">
                          </div>
                          <div class="u-form-group u-form-group-2">
                            <label for="img" class="u-label u-label-2">대표 이미지</label>
                            <input type="text" placeholder="이미지 주소 입력" id="img" name="img" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white u-input-2" required="required" value="${fundingInfo.img}">
                          </div><!-- always visible -->
                          <div class="u-form-email u-form-group">
                            <label for="email-cade" class="u-label u-label-3">가격</label>
                            <input type="text" id="email-cade" name="price" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white u-input-3" required="" placeholder="숫자만입력" value="${fundingInfo.price}">
                          </div>
                          <div class="u-form-group u-form-group-4">
                            <label for="text-bb8f" class="u-label u-label-4">펀딩 성공금액</label>
                            <input type="text" placeholder="숫자만 입력" id="text-bb8f" name="goal_amount" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white u-input-4" required="required" value="${fundingInfo.goal_amount}">
                          </div>
                          ...
                          <div class="u-form-group u-form-message">
                            ...
                            <textarea placeholder="내용입력" rows="10" cols="50" id="message-cade" name="content" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white" required=""> ${fundingInfo.content}"</textarea>
                          </div>
                          <div class="u-form-group u-form-group-8">
                            <label for="text-4419" class="u-label u-label-8">서브 이미지</label>
                            <input type="text" placeholder="이미지 주소 ^" id="text-4419" name="sub_img" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white u-input-8" required="required" value="${fundingInfo.sub_img}">
                          </div>
                          <div class="u-form-group u-form-select u-form-group-9">
                            <label for="fc_no" class="u-label u-label-9">카테고리 선택</label>
                          ...
                          <input type="submit"  value="스토어 등록하기"  class="u-border-2 u-border-active-black u-border-grey-dark-1 u-border-hover-black u-border-radius-0 u-btn u-btn-round u-btn-submit u-button-style u-radius-33 u-btn-1">
                        </form>
                      </div>
                    </div>
                  </div>
